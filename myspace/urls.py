...
urlpatterns = [
    ...
    path('admin/corporate-clients/<int:pk>/',
         admin_views.admin_corporate_client_detail,
         name='admin_corporate_client_detail'),
    ...
    path('admin/corporate-clients/<int:pk>/delete/',
         admin_views.admin_corporate_client_delete,
         name='admin_corporate_client_delete'),
    ...
    path('admin/corporate-clients/<int:client_pk>/users/',
         admin_views.admin_corporate_client_users,
         name='admin_corporate_client_users'),
    path('admin/corporate-clients/<int:client_pk>/users/create/',
         admin_views.admin_corporate_client_user_create,
         name='admin_corporate_client_user_create'),
    path('admin/corporate-clients/<int:client_pk>/users/<int:user_pk>/edit/',
         admin_views.admin_corporate_client_user_edit,
         name='admin_corporate_client_user_edit'),
    path('admin/corporate-clients/<int:client_pk>/users/<int:user_pk>/toggle-active/',
         admin_views.admin_corporate_client_user_toggle_active,
         name='admin_corporate_client_user_toggle_active'),

    # ── Admin: Overview ────────────────────────────────────────────────────────
    path('admin/jobs/',
         admin_views.admin_job_overview,
         name='admin_myspace_job_overview'),
    path('admin/jobs/<int:job_pk>/delete/',
         admin_views.admin_job_delete,
         name='admin_myspace_job_delete'),
    path('admin/submissions/',
         admin_views.admin_submission_overview,
         name='admin_myspace_submission_overview'),
    path('admin/submissions/<int:submission_pk>/delete/',
         admin_views.admin_submission_delete,
         name='admin_myspace_submission_delete'),
    path('admin/cart/',
